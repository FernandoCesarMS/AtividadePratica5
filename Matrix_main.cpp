...
int main()
{
    ...
    /*Falta no .h*/A(2,1) = 10;                               // altera o valor de uma posição de A
    C = A + A;                                  // Soma
    C -= A;                                     // Subtração       
    A = C - A;                                  // Subtração
    A += A;                                   // Soma
    /*Falta no .h*/A = ~C;                                  // A é igual a transposta de C
    ...
    /*n sei se ta certo no .h*/cout << Z << endl;                        // impressão de matrizes
    /*Falta no .h*/cin >> W;                                        // leitura de dados para dentro da matriz Y 
